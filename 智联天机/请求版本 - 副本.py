...
while f1 < 10:
    ...
    for i in range(len(companys[f1])):
        ...
        'isModify': 'false'}
        response = requests.post("https://customeraudit.zhaopin.com/customeraudit/service/inputCustomer/duplicateCheck", headers=headers1, data=payload)
        ...
        if name == companyname:
            ...
            if jsondata['canClaim'] and not ten:
                ...
                if a['code'] == 400:
                    ...
                    if f1 == 9:
                        f1 = -1
                    companys[f1 + 1] = companys[f1][i:] + companys[f1 + 1]
                    break
